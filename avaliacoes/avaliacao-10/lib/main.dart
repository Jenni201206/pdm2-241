  ...
  @override
   Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Avaliação 10: Validação de Formulário - Jennifer Mariano',
          textAlign: TextAlign.center,
        ),
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 221, 149, 206), // Cor de fundo da AppBar
      ),
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (!isValidDate(value)) {
                    return 'Data inválida. Exemplo válido: 21-09-2024';
                  }
                  return null;
                },
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (!isValidEmail(value)) {
                    return 'Email inválido. Exemplo válido: usuário@gmail.com';
                  }
                  return null;
                },
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'CPF: (apenas os números)'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Informe um CPF';
                  }
                  if (!isValidCPF(value)) {
                    return 'CPF inválido. Exemplo válido: xxx.xxx.xxx-xx (APENAS OS NÚMEROS)';
                  }
                  return null;
                },
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Valor: (Ex: 123.45)'),
